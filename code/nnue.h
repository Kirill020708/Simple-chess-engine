...
#include "incbin.h"
INCBIN(NETWORK, "code/quantised128.bin");

const int inputSize=64*12,hiddenLayerSize=128;
...
struct NNUEevaluator{
	...
	int evaluate(int color){
		...
		for(int i=0;i<hiddenLayerSize;i+=16){
			...
			outputV=_mm256_add_epi32(outputV,
									 _mm256_mullo_epi32(hl0,
									 					_mm256_cvtepi16_epi32(_mm256_extracti128_si256(w1v,0))));
			outputV=_mm256_add_epi32(outputV,
									 _mm256_mullo_epi32(hl1,
									 					_mm256_cvtepi16_epi32(_mm256_extracti128_si256(w1v,1))));
	    ...
	    __m128i sum128 = _mm_add_epi32(
	        _mm256_castsi256_si128(hadd2),
	        _mm256_extractf128_si256(hadd2, 1)
	    );
